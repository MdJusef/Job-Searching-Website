    ...
    <div class="container">
        ...
        <div class="row work-shap work-shop2">
            <div class="col-md-4">
                <div class="work-item">
                    <div class="img-icon">
                        <img src="{{ asset('frontEndAsset') }}/icons/wrk1.png" alt="">
                        <span>1</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="work-item">
                    <div class="img-icon">
                        <img src="{{ asset('frontEndAsset') }}/icons/wrk2.png" alt="">
                        <span>2</span>
                    </div>
            ...
            <div class="col-md-4">
                <div class="work-item">
                    <div class="img-icon">
                        <img src="{{ asset('frontEndAsset') }}/icons/wrk3.png" alt="">
                        <span>3</span>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="single-team">
                    <div class="team-img">
                        <img src="{{ asset('frontEndAsset') }}/team/1.jpg" alt="jobhere">
                    </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="single-team">
                    <div class="team-img">
                        <img src="{{ asset('frontEndAsset') }}/team/2.jpg" alt="jobhere">
                    </div>
                    <div class="team-content">
                        <h5>Jon Dowe</h5>
                        <h6>CEO Jobhere</h6>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="single-team">
                    <div class="team-img">
                        <img src="{{ asset('frontEndAsset') }}/team/3.jpg" alt="jobhere">
                    </div>
                    <div class="team-content">
                        <h5>Jon Dowe</h5>
                        <h6>CEO Jobhere</h6>

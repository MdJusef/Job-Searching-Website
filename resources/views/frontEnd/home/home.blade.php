    ...
    <div class="woring-area pt-130 pb-100 pt-sm-60 pb-sm-30">
        <div class="container">
            ...
            <div class="row work-shap"
                 style="background-image: url({{ asset('frontEndAsset/images/icons/work-shap.png')}})">
                <div class="col-md-4">
                    <div class="work-item">
                        <div class="img-icon">
                        ...
                        <p>Lorem ipsum dolor sit amet, contetur adipisil elit, sed do eiusmod tempor incididunt ut lab
                    ...
                    <div class="testimonial-carousel carousel-style-one">
                        <div class="single-testimonial">
                            <div class="testimonial-text pt-46">
                                <p class="text-white p-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                                    do eiusmod tem incidi ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                    quis nostru exercitation ullamco laboris nisi ut aliquip</p>
                            </div>
            ...
            <div class="blog-carousel carousel-style-two">
                ...
                <div class="single-blog hover-effect">
                    ...
                    <div class="blog-text">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adiicing elit, sed do eiusmod tempor incididunt ut
                            labore et dolor magna aliqua. Ut enim</p>
                    </div>
                </div>
                <!-- Single Item End -->
                <!-- Single Item Start -->
